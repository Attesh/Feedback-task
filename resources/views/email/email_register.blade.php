...
<head>
    ...
    <title>Account Created</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <td valign="start" class="hero bg_white" style="padding: 2em 0 4em 0;">
                    <table>
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em;">
                                    <p>Dear  <strong>{{ $data1['name'] }}</strong>,</p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="text" style="padding: 10px 2.5em;">
                                    <p>Congratulations. Your Account has been created. Please use the link below to proceed further.
                                    </p><br>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em;">
                                <span class="login">Click the link below to login</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
