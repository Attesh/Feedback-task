...
<head>
    ...
    <title>OTP Verification</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                ...
                <td valign="start" class="hero bg_white" style="padding: 2em 0 4em 0;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 10px 2.5em;">
                                    <p>Thank you for choosing Auction Sheet check. Use the following OTP to complete the procedure.
                                    </p><br>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em;">
                                <span class="login btn-primary">{{ $data1['otp'] }}</span>
                              </div>
                            </td>
                        </tr>
