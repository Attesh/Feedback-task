          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Feedback <span>/ This Weak</span></h5>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Feedback <span>/ This Month</span></h5>
            ...
            <!-- <div class="col-xxl-4 col-md-6">
              <div class="card info-card speaker-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Speakers <span>/ Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card rating-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Rating <span>/ Today</span></h5>
